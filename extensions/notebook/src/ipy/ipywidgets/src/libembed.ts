...
const Ajv = requirejs('ajv');
import { WidgetManager } from './manager';
const widget_state_schema = requirejs('@jupyter-widgets/schema').v2.state;
const widget_view_schema = requirejs('@jupyter-widgets/schema').v2.view;
